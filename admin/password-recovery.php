...
<html lang="en">
    <head>
        ...
        <title>Muna Madan Bookstore System | Password Recovery </title>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-5">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    <div class="card-header"><h3 class="text-center font-weight-light my-4">Book Store | Password Recovery</h3></div>
                                    <div class="card-body">
