...
<html lang="en">
<head>
	<title>Muna Madan Bookstore||Book Shop Page</title>
...
<?php $query=mysqli_query($con,"select category.id as catid,category.categoryName from category limit 8");
$cnt=1;
...
<?php } ?>
				...
				<div class="dis-none panel-search w-full p-t-10 p-b-15">
					...
					<div class="bor8 dis-flex p-l-15">
						...
						<input class="mtext-107 cl2 size-114 plh2 p-r-15" type="text" name="search" required placeholder="Search">
					</div>			</form>
				</div>
